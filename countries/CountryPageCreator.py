...
for country in countries:
    date = "07-10-2020" # change daily
    date2 = "7/10/20" # change daily
    if country == "Taiwan*":
        country = "Taiwan"
    fileout = open(country + ".html", "w")
    if country == "Taiwan": fileout.write('''<html>

    <head>

        <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-171520459-2"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());

            gtag('config', 'UA-171520459-2');
        </script>

        <title>COVID-19 Dashboard</title>

        <script src="../data/''' + date + '''-country.js"></script> <!--change daily-->
        
        <script>
            currentdate = "''' + date2 + '''"; // change daily
            countryname = "Taiwan*";
            dailydata = data;
        </script>
            ...
            <div class="col s12 m12 l9" id="countrytable">
                <div class="card material-table">
                    <div class="table-header">
                        ...
                        <script>
                            document.getElementById("tabletitle").innerHTML = "Taiwan Database";
                        </script>
                        <div class="actions">
    ...
    <script>
        ...
        function global(){
            ...
            for(i=0; i<dailydata.length; i++){
                if(dailydata[i]["name"] == countryname) {
                    total += dailydata[i]["active"];
                }
            }
